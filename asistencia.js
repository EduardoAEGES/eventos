...
document.getElementById('registration-form').addEventListener('submit', async (e) => {
    ...
    btnSubmit.innerHTML = '<i class="ph ph-spinner ph-spin"></i> Registrando Asistencia...';
    ...
    try {
        ...
        const stars = document.getElementsByName('calificacion');
        ...
        if (calificacion === 0) {
            throw new Error('Por favor, selecciona una calificación para el evento.');
        }
        ...
        const attendanceData = {
            ...
            certificado_autorizado: true // Por defecto false hasta que el admin apruebe
        };

        // 1. Guardar/Actualizar asistencia en la nueva tabla 'asistencias'
        const { error: insertError } = await supabaseClient
            .from('asistencias')
            .upsert(attendanceData, { onConflict: 'dni, evento_id' });
        ...
        Swal.fire({
            ...
            text: 'Tus datos y calificación han sido recibidos correctamente.',
            icon: 'success',
